...
def change_mac_address(iface, new_mac_address):
    ...
    # change the MAC
    # here hw specifies that the changes are being made to the hardware
    # ether indicates that we are setting up a new (ethernet)(mac) address for the interface
...
# when sending in cli arguments specify either -r (signal for random mac generation) or -m (signal for the specified mac address)